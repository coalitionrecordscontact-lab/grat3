        ...
        {allSaved && !validated &&
          <motion.div
            ...
            <button
              ...
              className="w-full font-rounded text-base rounded-2xl py-4 shadow-md active:scale-95 transition-transform bg-[hsl(var(--popover-foreground))] text-[hsl(var(--card))]">
